...
#No exercicio foram usadas muitas linhas para facer as somas, subtraçoes, divisoes e etc, entao fiz de uma maneira onde tudo poderia ser feito em uma linha ou duas.
